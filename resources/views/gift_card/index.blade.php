...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        ref.get().then(async function (snapshots) {
            ...
            $('#giftCardTable').DataTable({
                order: (checkDeletePermission==true) ? [3, "asc"] : [2,"asc"],
                    columnDefs: [
    ...
    async function getListData(val) {
        ...
        html = html + '<td data-order="'+val.expiryDay+'" >'+val.expiryDay+' Days</td>';
        if (val.isEnable) {
        ...
        if(checkDeletePermission){
        html=html+'<a id="' + val.id + '" name="giftcard-delete" href="javascript:void(0)" class="link-td do_not_delete"><i class="fa fa-trash"></i></a>';
        }
        html=html+'</td>';

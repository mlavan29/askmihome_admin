...
<nav class="sidebar-nav">
    ...
    @if(in_array('admins',$role_has_permission) || in_array('roles',$role_has_permission))
        ...
        <li><a class="waves-effect waves-dark" href="{!! url('stores') !!}" aria-expanded="false">
                ...
                <span class="hide-menu">{{trans('lang.stores_plural')}}</span>
    ...
    @endif
        ...
        @if(in_array('payments',$role_has_permission) || in_array('store-payouts',$role_has_permission) ||
        ...
        <li><a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
            ...
            <ul aria-expanded="false" class="collapse">
                @if(in_array('payments',$role_has_permission))
                   <li><a href="{!! url('payments') !!}">{{trans('lang.store_payment_plural')}}</a></li>
                @endif

                @if(in_array('store-payouts',$role_has_permission))
                <li><a href="{!! url('storesPayouts') !!}">{{trans('lang.restaurants_payout_plural')}}</a></li>
                @endif
                ...
                @if(in_array('payout-request-store',$role_has_permission))

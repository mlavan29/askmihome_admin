                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="checkbox" id="payout-request-driver"
                                                       value="payoutRequests.drivers" name="payout-request-driver[]"
                                                       class="permission"
                                                ...
                                                <input type="checkbox" id="payout-request-restaurant"
                                                       value="payoutRequests.restaurants" name="payout-request-store[]"
                                                       class="permission"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="checkbox" id="banners-delete"
                                                       ...
                                                       name="banners[]" class="permission"
                                                        {{in_array('setting.banners.delete',$permissions) ? "checked" : ""
                                                        }} {{$roles->id == 1 ? 'disabled' : ''}}>
                                                <label class="contol-label2"

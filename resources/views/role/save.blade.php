                                    ...
                                    <div class="col-12">
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox" id="restaurants-list" value="stores"
                                                           name="stores[]"
                                                           class="permission">
                                                    <label class=" control-label2"
                                                    ...
                                                    <input type="checkbox" id="restaurants-copy" value="stores.copy"
                                                           name="stores[]" class="permission">
                                                    <label class="contol-label2"
                                                           for="restaurants-copy">{{trans('lang.copy')}}</label>
                                            ...
                                            <tr>
                                                <td>
                                                    <strong>{{trans('lang.vendor_plural')}} {{trans('lang.payment_plural')}}</strong>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="checkbox" id="payout-request-restaurant"
                                                           value="payoutRequests.restaurants"
                                                           name="payout-request-store[]" class="permission">
                                                    <label class=" control-label2"

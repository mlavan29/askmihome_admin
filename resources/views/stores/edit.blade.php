            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                                href="{!! route('stores') !!}">{{trans('lang.vendor_plural')}}</a></li>
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row width-50">
                                        ...
                                        <div class="col-7">
                                            ...
                                            onkeypress="return chkNumbers2(event,'error5')">
                      ...
                      trans('lang.bank_name')}}</label>
                                            <div class="col-7">
                                                <input type="text" name="bank_name" class="form-control" id="bankName"
                                                 onkeypress="return chkNumbers2(event,'bankName_err')">
                                        <div id="bankName_err" class="err"></div>
                      ...
                      trans('lang.branch_name')}}</label>
                                            <div class="col-7">
                                                <input type="text" name="branch_name" class="form-control"
                                                       id="branchName"  
                                                       onkeypress="return chkNumbers2(event,'branchName_err')">
                                        <div id="branchName_err" class="err"></div>
                      ...
                      trans('lang.holer_name')}}</label>
                                            <div class="col-7">
                                                <input type="text" name="holer_name" class="form-control"
                                                       id="holderName" 
                                                       onkeypress="return chkNumbers2(event,'holer_name_err')">
                                        <div id="holer_name_err" class="err"></div>
                      ...
                      trans('lang.account_number')}}</label>
                                            <div class="col-7">
                                                <input type="text" name="account_number" class="form-control"
                                                       id="accountNumber"     onkeypress="return chkAlphabets2(event,'error3')">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12">
                                                    <button type="button" class="btn btn-primary"
                                                            onclick="addMoreButton('Saturday','Saturday','1')">{{trans('lang.add_more')}}</button>
                                                </div>
                                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        function deleteOffer(day, count, i) {
            $('.' + i + '_' + count + '_row').hide();
            if(count==0){
              $(".restaurant_discount_options_" + day + "_div").hide();
        ...
        function deleteWorkingHour(day, count, i) {
            $('.' + i + '_' + count + '_row').hide();
            if(count==0){
                $(".restaurant_working_hour_" + day + "_div").hide();

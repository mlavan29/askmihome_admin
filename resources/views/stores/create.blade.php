            ...
            <div>
                ...
                <div class="card-body">
                    ...
                    <div class="row restaurant_payout_create">
                        ...
                        <fieldset>
                            <legend>{{trans('lang.store')}} {{trans('lang.active_deactive')}}</legend>
                            <div class="form-group row">
                                        ...
                                        <div class="form-group row width-100">
                                            ...
                                            <div class="col-7">
                                                <input type="text" name="branch_name" class="form-control"
                                                       id="branchName"  onkeypress="return chkNumbers2(event,'branchName_err')">
                                        ...
                                        <div class="form-group row width-100">
                                            ...
                                            <div class="col-7">
                                                <input type="text" name="holer_name" class="form-control"
                                                       id="holderName" onkeypress="return chkNumbers2(event,'holer_name_err')">

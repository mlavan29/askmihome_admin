...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-5 align-self-center">
            ...
            <h3 class="text-themecolor">{{trans('lang.stores_plural')}}</h3>
        ...
        <div class="col-md-7 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">{{trans('lang.stores_plural')}}</li>
                ...
                <div class="card">
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{!! route('stores.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.create_restaurant')}}</a>
                            </li>
...
<script type="text/javascript">
    ...
    async function getListData(val) {
        ...
        trroute1 = trroute1.replace(':id', vendorUserId);

        // html = html + '<td><a href="' + trroute1 + '">{{trans("lang.order_transactions")}}</a></td>';

        var payoutRequests = '{{route("payoutRequests.stores.view",":id")}}';
        ...
        html = html + '<td class="vendor-action-btn"><?php if (in_array('stores.copy', json_decode(@session('user_permissions')))) { ?><a href="javascript:void(0)" vendor_id="' + val.id + '" author="' + val.author + '" name="vendor-clone"><i class="fa fa-clone"></i></a><?php }?><a href="' + route_view + '"><i class="fa fa-eye"></i></a><a href="' + route1 + '"><i class="fa fa-edit"></i></a>';
        if (checkDeletePermission) {
